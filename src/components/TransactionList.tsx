  ...
  return (
    <div className="grid gap-2">
      {visibleTransactions.length === 0 ? (
        <div className="rounded-[22px] border border-dashed border-line bg-white/80 p-4 text-[15px] font-semibold text-muted">
          {emptyLabel}
        </div>
      ) : (
        visibleTransactions.map((transaction) => {
          ...
          return (
            ...
            >
              ...
              <p className="shrink-0 text-[15px] font-extrabold text-ink">
